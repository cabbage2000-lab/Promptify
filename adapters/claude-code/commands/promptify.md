...
1. Read the repository-root files `shared/task-routing.md`, `shared/safety.md`, and `shared/brief-standard.md`.
2. Classify `$ARGUMENTS`.
3. Select the matching repository-root file from `shared/templates/`.
