...
- Review current session history first: completed changes, locked-in decisions, and where the work stopped.
- Do minimal read-only project discovery to verify real progress: `git status`, recent diffs, and any `PLAN.md` or task artifacts mentioned in the session.
