...
- 覆盖 bugfix、feature、refactor、test、review、docs、prototyping、planning、PRD、long-running goal 等常见开发任务。
...
| Prototype | `skills/promptify/shared/templates/prototype.md` |
